...
Before executing the `upload` command, you may need to go to the Blocklet Store to request an access key, which can be found [here](https://developer.blocklet.io/docs/en/developer/publish-blocklets)
